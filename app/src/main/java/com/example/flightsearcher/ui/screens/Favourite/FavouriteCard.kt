...
//@Composable
//fun FavouriteCard(depart: String,departCode: String, arrive:String, arriveCode:String,checked: Boolean,viewModel: FlightSearchViewModel){
...
//            IconButton(
//                onClick = {
//                    viewModel.faveClicked(arrivalCode = arrive, departCode = departCode, checked = checked)
//                          },
